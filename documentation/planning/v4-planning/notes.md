...
Much wider and hardened dependency resolver that can resolve any dependency within the repo even hidden dependencies.

1. Improve dependency finder agent.
2. Improve static dependency finder.
3. Robust resolver for all supported ecosystems